...
export class SignupPage {
  ...
  signupUser() {
    if (!this.signupForm.valid) {
      let alert = this.alertCtrl.create({
        title: "Failed",
        message: `Need to complete the form: ${this.signupForm.value}`,
  ...
  public text1: string = `iTaxi 이용약관
    ...
    3. "이용자 ID"는 회원의 식별과 회원의 서비스 이용을 위하여 회원의 이메일을 말합니다. 
    ...
    2. 한동대학교 CRA는 불가피한 사정에 따라 본 약관을 변경할 수 있으며, 변경된 약관은 제 3조 1항의 방법을 통해 효력을 발생합니다.
    ...
    1. 한동대학교 CRA iTaxi팀은 제 5조 규정에 의한 이용 신청 고객에 대하여 업무 수행상 또는 기술상의 지장이 없는 경우 원칙적으로 접수 순서에 따라 서비스 이용을 승낙합니다.
    ...
    1. 서비스 이용은 한동대학교 CRA iTaxi팀의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간 운영을 원칙으로 하며 새로운 서비스로의 교체 또는 기타 '한동대학교 CRA iTaxi팀'가 적절하다고 판단하는 사유에 기하여 현재 제공되는 서비스를 완전히 중단할 수 있습니다.
    ...
    1. 회원이 등록한 이용자 ID 및 비밀번호에 의하여 발생되는 사용상의 과실 또는 제3자에 의한 부정사용 등에 대한 모든 책임은 해당 회원에게 있습니다. 다만, 한동대학교 CRA iTaxi팀의 고의 또는 중과실이 있는 경우에는 그러하지 아니합니다.

    2. 한동대학교 CRA는 이용자 ID에 의하여 제반 이용자 관리업무를 수행하므로 이용고객이 이용자 ID를 변경하고자 하는 경우 한동대학교 CRA iTaxi팀이 인정할 만한 사유가 없는 한, 이용자 ID의 변경을 제한할 수 있습니다.
    ...
    한동대학교 CRA iTaxi팀은 회원이 서비스 이용 중 필요가 있다고 인정되는 다양한 정보에 대해서는 전자우편이나 서신우편 등의 방법으로 이용자에게 제공할 수 있습니다.
  ...
  CRA iTaxi의 개인정보 보호정책은 다음과 같은 내용을 담고 있습니다.

  가. 개인정보의 수집목적 및 이용목적
  나. 목적 외 사용 및 제3자에 대한 제공
  다. 개인정보의 열람정정
  라. 개인정보 수집, 이용, 제공에 대한 동의철회
  마. 개인정보의 보유기간 및 이용기간
  바. 개인정보보호를 위한 기술적 대책
  사. 개인정보의 위탁처리
  아. 의견수렴 및 불만처리
  ...
  3. 한동대학교 CRA iTaxi팀은 사용자를 한동대학교 학생으로 제한하기 위하여 귀하에게서 이름과 학번을 수집하고 있습니다. 올바르지 못한 정보를 입력하실 경우 사이트 가입은 거부됩니다. 또한, 편리한 서비스 제공을 위해 귀하의 휴대전화번호 11자리를 수집하고 있습니다.


  나. 목적 외 사용 및 제3자에 대한 제공 

  1. 한동대학교 CRA iTaxi팀은 귀하의 개인정보를 개인정보의 수집목적 및 이용목적에서 고지한 범위내에서 사용하며, 동 범위를 초과하여 이용하거나 타인 또는 타기업기관에 제공하지 않습니다. 다만, 다음의 경우에는 그러하지 아니합니다.

  첫째, iTaxi 서비스를 이용하여 타인에게 정신적, 물질적 피해를 줌으로써 그에 대한 법적인 조치를 취하기 위하여 개인정보를 공개해야 한다고 판단되는 충분한 근거가 있는 경우
  둘째, 기타 법에 의해 요구된다고 선의로 판단되는 경우
  ...
  - 회원가입정보의 경우, 회원가입을 탈퇴하거나 회원에서 제명된 두달 후
  ...
  1. 귀하의 개인정보는 특별히 인가된 책임 관리자 이외에 접근 또는 보관, 관리 할 수 없습니다.
