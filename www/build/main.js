...
=======
        selector: 'page-home',template:/*ion-inline-start:"C:\Users\SEC\cra\i_taxi\src\pages\home\home.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Home</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <h3>Ionic Menu Starter</h3>\n\n\n\n  <p>\n\n    If you get lost, the <a href="http://ionicframework.com/docs/v2">docs</a> will show you the way.\n\n  </p>\n\n\n\n  <button ion-button secondary menuToggle>Toggle Menu</button>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\SEC\cra\i_taxi\src\pages\home\home.html"*/
>>>>>>> makeRoom
    }),
...
=======
        selector: 'page-list',template:/*ion-inline-start:"C:\Users\SEC\cra\i_taxi\src\pages\list\list.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>List</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <ion-list>\n\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n\n      {{item.title}}\n\n      <div class="item-note" item-end>\n\n        {{item.note}}\n\n      </div>\n\n    </button>\n\n  </ion-list>\n\n  <div *ngIf="selectedItem" padding>\n\n    You navigated here from <b>{{selectedItem.title}}</b>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\SEC\cra\i_taxi\src\pages\list\list.html"*/
>>>>>>> makeRoom
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]])
], ListPage);
...
=======
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"C:\Users\SEC\cra\i_taxi\src\pages\makeRoom\makeRoom.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>i-taxi >> MakeRoom</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <ion-row style="border:1px solid; border-color:#29B5EF; height:8%">\n\n    <ion-col>\n\n      <ion-label color="primary" display="flex" align="center" fixed>출발장소</ion-label>\n\n    </ion-col>\n\n    <ion-col>\n\n      <div class="room_button"> \n\n        <button style="margin-top:-7%" class="swap-button" ion-button clear large icon-only (click)="swap_position()">\n\n          <ion-icon name="swap"></ion-icon>\n\n        </button>\n\n      </div>\n\n    </ion-col>\n\n    <ion-col>\n\n      <ion-label style="margin-left:-38%" color="primary" align="center" fixed>도착장소</ion-label>\n\n    </ion-col>\n\n  </ion-row>\n\n\n\n  <ion-row>\n\n    <ion-col style="border:1px solid; border-color:#29B5EF;">\n\n      <!--<ion-label align="center" color="primary" fixed>출발장소</ion-label> -->  \n\n      <ion-item>\n\n        <ion-select class="my-select" [(ngModel)]="start" interface="popover" *ngIf="start!=\'직접입력\'">\n\n          <ion-option *ngFor="let start_list of start_list">{{start_list.start_list}}</ion-option>\n\n        </ion-select>\n\n        <ion-input  style="position:absolute" *ngIf="start==\'직접입력\'" [(ngModel)]="start2" type="text" placeholder="기타장소"></ion-input>  \n\n      </ion-item>\n\n    </ion-col>\n\n\n\n    <ion-col style="border:1px solid; border-color:#29B5EF;">\n\n      <!--<ion-label align="center" color="primary" (click)="labelClick()" fixed>도착장소</ion-label>-->\n\n      <ion-item>\n\n        <ion-select class="my-select" interface="popover" *ngIf="arrive!=\'직접입력\'" [(ngModel)]="arrive">\n\n                \n\n          <ion-option value="한동대학교">한동대학교</ion-option>\n\n          <ion-option value="포항역">포항역</ion-option>\n\n          <ion-option value="양덕">양덕</ion-option>\n\n          <ion-option value="고속버스터미널">고속버스터미널</ion-option>\'\n\n          <ion-option value="시외버스터미널">시외버스터미널</ion-option>\n\n          <ion-option value="북부해수욕장">북부해수욕장</ion-option>\n\n          <ion-option value="육거리">육거리</ion-option>\n\n          <ion-option value="직접입력" >직접입력</ion-option>\n\n                    \n\n        </ion-select> \n\n        <ion-input  style="position:absolute" *ngIf="arrive==\'직접입력\'" [(ngModel)]="arrive2" type="text" placeholder="기타장소"></ion-input>  \n\n                    \n\n      </ion-item>\n\n              \n\n    </ion-col>\n\n  </ion-row>\n\n  \n\n  <ion-row style="border:1px solid; border-color:#29B5EF; height:8%">\n\n    <ion-col>\n\n      <ion-label color="primary" display="flex" align="center" fixed>출발날짜</ion-label>\n\n    </ion-col>\n\n    <ion-col>\n\n      <ion-label color="primary" align="center" fixed>출발시간</ion-label>\n\n    </ion-col>\n\n  </ion-row>\n\n\n\n  <ion-row>\n\n    <ion-col style="border:1px solid; border-color:#29B5EF;">\n\n      <div class="start-date">\n\n        <!--<ion-label align="center" color="primary" fixed>출발날짜</ion-label>-->\n\n        <ion-item>       \n\n          <ion-datetime displayFormat="YYYY MM DD" pickerFormat="YYYY MM DD" [(ngModel)]="startDate"></ion-datetime>\n\n        </ion-item>\n\n      </div>\n\n    </ion-col>\n\n    <ion-col style="border:1px solid; border-color:#29B5EF;">\n\n      <div class="start-time">\n\n          <!--<ion-label align="center" color="primary" fixed>출발시간</ion-label>-->\n\n        <ion-item >           \n\n          <ion-datetime displayFormat="h:mm A" pickerFomat="h mm A" [(ngModel)]="startTime"></ion-datetime>\n\n        </ion-item>\n\n      </div>\n\n    </ion-col>\n\n  </ion-row>\n\n\n\n  <!--\n\n  <div class="room_button"> \n\n    <button class="swap-button" ion-button clear large icon-only (click)="swap_position()">\n\n      <ion-icon name="swap"></ion-icon>\n\n    </button>\n\n  </div>-->\n\n\n\n  <div class="room_button">          \n\n    <button  style="margin-top:10%" class="button customBtn" ion-button round (click)="showPeopleAlert()">방만들기</button>\n\n  </div>\n\n \n\n</ion-content>'/*ion-inline-end:"C:\Users\SEC\cra\i_taxi\src\pages\makeRoom\makeRoom.html"*/,
>>>>>>> makeRoom
    }),
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"C:\Users\SEC\cra\i_taxi\src\app\app.html"*/'<ion-menu [content]="content">\n\n  <ion-header>\n\n    <ion-toolbar>\n\n      <ion-title>Menu</ion-title>\n\n    </ion-toolbar>\n\n  </ion-header>\n\n\n\n  <ion-content>\n\n    <ion-list>\n\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n\n        {{p.title}}\n\n      </button>\n\n    </ion-list>\n\n  </ion-content>\n\n\n\n</ion-menu>\n\n\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"C:\Users\SEC\cra\i_taxi\src\app\app.html"*/
    }),
...
=======
        selector: 'page-select-and-sorting',template:/*ion-inline-start:"C:\Users\SEC\cra\i_taxi\src\pages\select-and-sorting\select-and-sorting.html"*/'<!--\n\n  Generated template for the SelectAndSortingPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>selectAndSorting</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <ion-item>\n\n    <ion-label>Gender</ion-label>\n\n    <ion-select [selectOptions]="selectOptions" [(ngModel)]="gender" multiple="true">\n\n      <ion-option value="f">Female</ion-option>\n\n      <ion-option value="m">Male</ion-option>\n\n    </ion-select>\n\n  </ion-item>\n\n\n\n  <ion-list>\n\n    <ion-item>\n\n      <ion-label>Select Hive</ion-label>\n\n      <ion-select #newSelect [(ngModel)]="carbrand" multiple="true" (ionChange)="IonChange(carbrand)">\n\n        <ion-option value="Porsche" checked="true">Porsche</ion-option>\n\n        <ion-option value="Mercedes" >Mercedes</ion-option>\n\n        <ion-option value="Buggati">Buggati</ion-option>\n\n        <ion-option value="Lamborghini">Lamborghini</ion-option>\n\n        <ion-option value="Domster">Domster</ion-option>\n\n      </ion-select>\n\n    </ion-item>\n\n  </ion-list>\n\n  \n\n  <ion-list>\n\n    <button menuClose ion-item *ngFor="let time of e1">\n\n      {{e1}}\n\n    </button>\n\n  </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\SEC\cra\i_taxi\src\pages\select-and-sorting\select-and-sorting.html"*/,
>>>>>>> makeRoom
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]])
], TaxiListPage);
